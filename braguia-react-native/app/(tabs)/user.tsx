...
export default function UserPage() {
  ...
  return (
    <ScrollView>
      ...
      <ProfileCard title="Name" icon="account" text={`${userInfo.first_name} ${userInfo.last_name}`} />
      ...
      <ProfileCard title="Last Login" icon="account" text={convertDate(userInfo.last_login)} />
      <ProfileCard title="Date Joined" icon="account" text={convertDate(userInfo.date_joined)} />
